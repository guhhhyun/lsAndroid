...
part of 'small_kit_new2_model.dart';
...
SmallKitNew2Model _$SmallKitNew2ModelFromJson(Map<String, dynamic> json) {
  return _SmallKitNew2Model.fromJson(json);
}

/// @nodoc
mixin _$SmallKitNew2Model {
  ...
  @JsonKey(ignore: true)
  $SmallKitNew2ModelCopyWith<SmallKitNew2Model> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SmallKitNew2ModelCopyWith<$Res> {
  factory $SmallKitNew2ModelCopyWith(
          SmallKitNew2Model value, $Res Function(SmallKitNew2Model) then) =
      _$SmallKitNew2ModelCopyWithImpl<$Res, SmallKitNew2Model>;
  @useResult
  $Res call(
      {Header? header,
      String resultCode,
...
/// @nodoc
class _$SmallKitNew2ModelCopyWithImpl<$Res, $Val extends SmallKitNew2Model>
    implements $SmallKitNew2ModelCopyWith<$Res> {
  _$SmallKitNew2ModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SmallKitNew2ModelImplCopyWith<$Res>
    implements $SmallKitNew2ModelCopyWith<$Res> {
  factory _$$SmallKitNew2ModelImplCopyWith(_$SmallKitNew2ModelImpl value,
          $Res Function(_$SmallKitNew2ModelImpl) then) =
      __$$SmallKitNew2ModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {Header? header,
...
/// @nodoc
class __$$SmallKitNew2ModelImplCopyWithImpl<$Res>
    extends _$SmallKitNew2ModelCopyWithImpl<$Res, _$SmallKitNew2ModelImpl>
    implements _$$SmallKitNew2ModelImplCopyWith<$Res> {
  __$$SmallKitNew2ModelImplCopyWithImpl(_$SmallKitNew2ModelImpl _value,
      $Res Function(_$SmallKitNew2ModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SmallKitNew2ModelImpl(
      header: freezed == header
          ? _value.header
          : header // ignore: cast_nullable_to_non_nullable
              as Header?,
...
/// @nodoc
@JsonSerializable()
class _$SmallKitNew2ModelImpl implements _SmallKitNew2Model {
  const _$SmallKitNew2ModelImpl(
      {this.header,
      this.resultCode = '',
      this.resultMessage = '',
  ...
  factory _$SmallKitNew2ModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$SmallKitNew2ModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'SmallKitNew2Model(header: $header, resultCode: $resultCode, resultMessage: $resultMessage, body: $body)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$SmallKitNew2ModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SmallKitNew2ModelImplCopyWith<_$SmallKitNew2ModelImpl> get copyWith =>
      __$$SmallKitNew2ModelImplCopyWithImpl<_$SmallKitNew2ModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SmallKitNew2ModelImplToJson(
      this,
    );
  }
}

abstract class _SmallKitNew2Model implements SmallKitNew2Model {
  const factory _SmallKitNew2Model(
      {final Header? header,
      final String resultCode,
      final String resultMessage,
      final List<dynamic>? body}) = _$SmallKitNew2ModelImpl;

  factory _SmallKitNew2Model.fromJson(Map<String, dynamic> json) =
      _$SmallKitNew2ModelImpl.fromJson;
...
class _$SubBodyItemImpl implements _SubBodyItem {
  ...
  @override
  String toString() {
    return 'SubBodyItem(pitmNm: $pitmNm, cbxMaNo: $cbxMaNo, itemNm: $itemNm, splitSeq: $splitSeq, wrkRemark: $wrkRemark, pjtNm2: $pjtNm2, wrkNo: $wrkNo, splitNo: $splitNo, cbxSuNo: $cbxSuNo, id: $id, cbxSuNm: $cbxSuNm, bomQty: $bomQty, cbxSuSeq: $cbxSuSeq, sboxSpec: $sboxSpec, wrkCfmYn: $wrkCfmYn, setCbxQty: $setCbxQty, wrkCfmDttm: $wrkCfmDttm, tagNo: $tagNo, itemCd: $itemCd, pitmCd: $pitmCd, wksNo: $wksNo, qtyUnit: $qtyUnit, wrkQty: $wrkQty, cbxQty: $cbxQty, setQty: $setQty)';
  }
