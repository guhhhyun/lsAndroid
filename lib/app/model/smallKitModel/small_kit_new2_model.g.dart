...
_$SmallKitNew2ModelImpl _$$SmallKitNew2ModelImplFromJson(
        Map<String, dynamic> json) =>
    _$SmallKitNew2ModelImpl(
...
Map<String, dynamic> _$$SmallKitNew2ModelImplToJson(
        _$SmallKitNew2ModelImpl instance) =>
    <String, dynamic>{
