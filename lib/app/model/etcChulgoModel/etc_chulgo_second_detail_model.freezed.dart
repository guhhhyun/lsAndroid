...
EtcChulgoSecondDetailModel _$EtcChulgoSecondDetailModelFromJson(
    Map<String, dynamic> json) {
  return _EtcChulgoSecondDetailModel.fromJson(json);
}

/// @nodoc
mixin _$EtcChulgoSecondDetailModel {
  ...
  @JsonKey(ignore: true)
  $EtcChulgoSecondDetailModelCopyWith<EtcChulgoSecondDetailModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $EtcChulgoSecondDetailModelCopyWith<$Res> {
  factory $EtcChulgoSecondDetailModelCopyWith(EtcChulgoSecondDetailModel value,
          $Res Function(EtcChulgoSecondDetailModel) then) =
      _$EtcChulgoSecondDetailModelCopyWithImpl<$Res,
          EtcChulgoSecondDetailModel>;
  @useResult
  $Res call(
      {Header? header,
      String resultCode,
...
/// @nodoc
class _$EtcChulgoSecondDetailModelCopyWithImpl<$Res,
        $Val extends EtcChulgoSecondDetailModel>
    implements $EtcChulgoSecondDetailModelCopyWith<$Res> {
  _$EtcChulgoSecondDetailModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$EtcChulgoSecondDetailModelImplCopyWith<$Res>
    implements $EtcChulgoSecondDetailModelCopyWith<$Res> {
  factory _$$EtcChulgoSecondDetailModelImplCopyWith(
          _$EtcChulgoSecondDetailModelImpl value,
          $Res Function(_$EtcChulgoSecondDetailModelImpl) then) =
      __$$EtcChulgoSecondDetailModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {Header? header,
...
/// @nodoc
class __$$EtcChulgoSecondDetailModelImplCopyWithImpl<$Res>
    extends _$EtcChulgoSecondDetailModelCopyWithImpl<$Res,
        _$EtcChulgoSecondDetailModelImpl>
    implements _$$EtcChulgoSecondDetailModelImplCopyWith<$Res> {
  __$$EtcChulgoSecondDetailModelImplCopyWithImpl(
      _$EtcChulgoSecondDetailModelImpl _value,
      $Res Function(_$EtcChulgoSecondDetailModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$EtcChulgoSecondDetailModelImpl(
      header: freezed == header
          ? _value.header
          : header // ignore: cast_nullable_to_non_nullable
              as Header?,
...
/// @nodoc
@JsonSerializable()
class _$EtcChulgoSecondDetailModelImpl implements _EtcChulgoSecondDetailModel {
  const _$EtcChulgoSecondDetailModelImpl(
      {this.header,
      this.resultCode = '',
      this.resultMessage = '',
  ...
  factory _$EtcChulgoSecondDetailModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$EtcChulgoSecondDetailModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'EtcChulgoSecondDetailModel(header: $header, resultCode: $resultCode, resultMessage: $resultMessage, body: $body, hasError: $hasError)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$EtcChulgoSecondDetailModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$EtcChulgoSecondDetailModelImplCopyWith<_$EtcChulgoSecondDetailModelImpl>
      get copyWith => __$$EtcChulgoSecondDetailModelImplCopyWithImpl<
          _$EtcChulgoSecondDetailModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$EtcChulgoSecondDetailModelImplToJson(
      this,
    );
  }
}

abstract class _EtcChulgoSecondDetailModel
    implements EtcChulgoSecondDetailModel {
  const factory _EtcChulgoSecondDetailModel(
      {final Header? header,
      final String resultCode,
      final String resultMessage,
      final List<dynamic>? body,
      final bool hasError}) = _$EtcChulgoSecondDetailModelImpl;

  factory _EtcChulgoSecondDetailModel.fromJson(Map<String, dynamic> json) =
      _$EtcChulgoSecondDetailModelImpl.fromJson;
...
class _$SubBodyItemImpl implements _SubBodyItem {
  ...
  @override
  String toString() {
    return 'SubBodyItem(wht: $wht, tagId: $tagId, WH_NM: $WH_NM, pjtNm: $pjtNm, grpKey: $grpKey, LOC_CD: $LOC_CD, expDt: $expDt, remark: $remark, itemNm: $itemNm, lotNo: $lotNo, usrNm: $usrNm, tagType: $tagType, vendNm: $vendNm, tagSeq: $tagSeq, whCd: $whCd, tagNo: $tagNo, itemCd: $itemCd, whtUnit: $whtUnit, setQty: $setQty, plant: $plant, qrNo: $qrNo, qty: $qty, tagTypeNm: $tagTypeNm, qtyUnit: $qtyUnit, prtDt: $prtDt)';
  }
