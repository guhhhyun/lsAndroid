...
OtherKitNew3Model _$OtherKitNew3ModelFromJson(Map<String, dynamic> json) {
  return _OtherKitNew3Model.fromJson(json);
}

/// @nodoc
mixin _$OtherKitNew3Model {
  ...
  @JsonKey(ignore: true)
  $OtherKitNew3ModelCopyWith<OtherKitNew3Model> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OtherKitNew3ModelCopyWith<$Res> {
  factory $OtherKitNew3ModelCopyWith(
          OtherKitNew3Model value, $Res Function(OtherKitNew3Model) then) =
      _$OtherKitNew3ModelCopyWithImpl<$Res, OtherKitNew3Model>;
  @useResult
  $Res call(
      {Header? header,
      String resultCode,
...
/// @nodoc
class _$OtherKitNew3ModelCopyWithImpl<$Res, $Val extends OtherKitNew3Model>
    implements $OtherKitNew3ModelCopyWith<$Res> {
  _$OtherKitNew3ModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$OtherKitNew3ModelImplCopyWith<$Res>
    implements $OtherKitNew3ModelCopyWith<$Res> {
  factory _$$OtherKitNew3ModelImplCopyWith(_$OtherKitNew3ModelImpl value,
          $Res Function(_$OtherKitNew3ModelImpl) then) =
      __$$OtherKitNew3ModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {Header? header,
...
/// @nodoc
class __$$OtherKitNew3ModelImplCopyWithImpl<$Res>
    extends _$OtherKitNew3ModelCopyWithImpl<$Res, _$OtherKitNew3ModelImpl>
    implements _$$OtherKitNew3ModelImplCopyWith<$Res> {
  __$$OtherKitNew3ModelImplCopyWithImpl(_$OtherKitNew3ModelImpl _value,
      $Res Function(_$OtherKitNew3ModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$OtherKitNew3ModelImpl(
      header: freezed == header
          ? _value.header
          : header // ignore: cast_nullable_to_non_nullable
              as Header?,
...
/// @nodoc
@JsonSerializable()
class _$OtherKitNew3ModelImpl implements _OtherKitNew3Model {
  const _$OtherKitNew3ModelImpl(
      {this.header,
      this.resultCode = '',
      this.resultMessage = '',
  ...
  factory _$OtherKitNew3ModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$OtherKitNew3ModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'OtherKitNew3Model(header: $header, resultCode: $resultCode, resultMessage: $resultMessage, body: $body)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$OtherKitNew3ModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$OtherKitNew3ModelImplCopyWith<_$OtherKitNew3ModelImpl> get copyWith =>
      __$$OtherKitNew3ModelImplCopyWithImpl<_$OtherKitNew3ModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$OtherKitNew3ModelImplToJson(
      this,
    );
  }
}

abstract class _OtherKitNew3Model implements OtherKitNew3Model {
  const factory _OtherKitNew3Model(
      {final Header? header,
      final String resultCode,
      final String resultMessage,
      final List<dynamic>? body}) = _$OtherKitNew3ModelImpl;

  factory _OtherKitNew3Model.fromJson(Map<String, dynamic> json) =
      _$OtherKitNew3ModelImpl.fromJson;
...
mixin _$SubBodyItem {
  ...
  String get cbxExSeq => throw _privateConstructorUsedError;
...
class _$SubBodyItemImpl implements _SubBodyItem {
  ...
  @override
  String toString() {
    return 'SubBodyItem(scanNo: $scanNo, wrkSeq: $wrkSeq, qtyUnit: $qtyUnit, syncYn: $syncYn, itemCd: $itemCd, cbxExNo: $cbxExNo, cbxExSeq: $cbxExSeq, itemNm: $itemNm, btn: $btn, wrkQty: $wrkQty, ncbxRmk: $ncbxRmk, vendNm: $vendNm, sboxNo: $sboxNo, bomQty: $bomQty)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.cbxExSeq, cbxExSeq) ||
                other.cbxExSeq == cbxExSeq) &&
