...
OtherKitNewModel _$OtherKitNewModelFromJson(Map<String, dynamic> json) {
  return _OtherKitNewModel.fromJson(json);
}

/// @nodoc
mixin _$OtherKitNewModel {
  ...
  @JsonKey(ignore: true)
  $OtherKitNewModelCopyWith<OtherKitNewModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OtherKitNewModelCopyWith<$Res> {
  factory $OtherKitNewModelCopyWith(
          OtherKitNewModel value, $Res Function(OtherKitNewModel) then) =
      _$OtherKitNewModelCopyWithImpl<$Res, OtherKitNewModel>;
  @useResult
  $Res call(
      {Header? header,
      String resultCode,
...
/// @nodoc
class _$OtherKitNewModelCopyWithImpl<$Res, $Val extends OtherKitNewModel>
    implements $OtherKitNewModelCopyWith<$Res> {
  _$OtherKitNewModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$OtherKitNewModelImplCopyWith<$Res>
    implements $OtherKitNewModelCopyWith<$Res> {
  factory _$$OtherKitNewModelImplCopyWith(_$OtherKitNewModelImpl value,
          $Res Function(_$OtherKitNewModelImpl) then) =
      __$$OtherKitNewModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {Header? header,
...
/// @nodoc
class __$$OtherKitNewModelImplCopyWithImpl<$Res>
    extends _$OtherKitNewModelCopyWithImpl<$Res, _$OtherKitNewModelImpl>
    implements _$$OtherKitNewModelImplCopyWith<$Res> {
  __$$OtherKitNewModelImplCopyWithImpl(_$OtherKitNewModelImpl _value,
      $Res Function(_$OtherKitNewModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$OtherKitNewModelImpl(
      header: freezed == header
          ? _value.header
          : header // ignore: cast_nullable_to_non_nullable
              as Header?,
...
/// @nodoc
@JsonSerializable()
class _$OtherKitNewModelImpl implements _OtherKitNewModel {
  const _$OtherKitNewModelImpl(
      {this.header,
      this.resultCode = '',
      this.resultMessage = '',
  ...
  factory _$OtherKitNewModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$OtherKitNewModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'OtherKitNewModel(header: $header, resultCode: $resultCode, resultMessage: $resultMessage, body: $body)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$OtherKitNewModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$OtherKitNewModelImplCopyWith<_$OtherKitNewModelImpl> get copyWith =>
      __$$OtherKitNewModelImplCopyWithImpl<_$OtherKitNewModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$OtherKitNewModelImplToJson(
      this,
    );
  }
}

abstract class _OtherKitNewModel implements OtherKitNewModel {
  const factory _OtherKitNewModel(
      {final Header? header,
      final String resultCode,
      final String resultMessage,
      final List<dynamic>? body}) = _$OtherKitNewModelImpl;

  factory _OtherKitNewModel.fromJson(Map<String, dynamic> json) =
      _$OtherKitNewModelImpl.fromJson;
...
/// @nodoc
mixin _$SubBodyItem {
  int get cbxExSeq => throw _privateConstructorUsedError;
...
class _$SubBodyItemImpl implements _SubBodyItem {
  ...
  @override
  String toString() {
    return 'SubBodyItem(cbxExSeq: $cbxExSeq, tagNo: $tagNo, cancleFlag: $cancleFlag, convQty: $convQty, wrkQty: $wrkQty, oderQty: $oderQty, qrNo: $qrNo)';
  }
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, cbxExSeq, tagNo, cancleFlag, convQty, wrkQty, oderQty, qrNo);
