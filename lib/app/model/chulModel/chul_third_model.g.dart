...
_$ChulThirdModelImpl _$$ChulThirdModelImplFromJson(Map<String, dynamic> json) =>
    _$ChulThirdModelImpl(
...
Map<String, dynamic> _$$ChulThirdModelImplToJson(
        _$ChulThirdModelImpl instance) =>
    <String, dynamic>{
