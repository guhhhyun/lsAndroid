...
// body는 다양한 타입의 요소들을 포함하므로 dynamic으로 설정
  ...
  @override
  String toString() {
    return 'LocationModel(header: $header, resultCode: $resultCode, resultMessage: $resultMessage, body: $body, hasError: $hasError)';
  }
...
abstract class _LocationModel implements LocationModel {
  factory _LocationModel(
      ...
      final String resultMessage,
      final List<dynamic>? body,
      final bool hasError}) = _$LocationModelImpl;
...
abstract class $InboundItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({String zoneCd, String zoneNm, String locCd});
}
...
class _$InboundItemImpl implements _InboundItem {
  _$InboundItemImpl({this.zoneCd = '', this.zoneNm = '', this.locCd = ''});
  ...
  @override
  String toString() {
    return 'InboundItem(zoneCd: $zoneCd, zoneNm: $zoneNm, locCd: $locCd)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, zoneCd, zoneNm, locCd);
...
abstract class _InboundItem implements InboundItem {
  factory _InboundItem(
      {final String zoneCd,
      final String zoneNm,
      final String locCd}) = _$InboundItemImpl;
